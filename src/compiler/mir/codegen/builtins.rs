...
pub(crate) fn builtin_to_pal(name: &str) -> Option<&'static str> {
    match name {
        ...
        // Filesystem
        "fs.write" => Some("pal_fs_write"),
        "fs.append" => Some("pal_fs_append"),
        "fs.read" => Some("pal_fs_read"),
        "fs.copy" => Some("pal_fs_copy"),
        "fs.move" => Some("pal_fs_move"),
        "fs.drop" => Some("pal_fs_delete"),
        "fs.mkdir" => Some("pal_fs_mkdir"),
        "fs.rmdir" => Some("pal_fs_rmdir"),
        "fs.exists" => Some("pal_fs_exists"),
        "fs.is_dir" => Some("pal_fs_is_dir"),
        "fs.is_file" => Some("pal_fs_is_file"),
        "fs.size" => Some("pal_fs_size"),
        "sleep_ms" => Some("pal_time_sleep_ms"),
        "fs.list" => Some("pal_fs_list"),
        "fs.walk" => Some("pal_fs_walk"),
        "fs.join" => Some("pal_fs_join"),
        "fs.dir" => Some("pal_fs_dir"),
        "fs.name" => Some("pal_fs_name"),
        "fs.ext" => Some("pal_fs_ext"),
        // Process
        "proc.run" => Some("pal_proc_run"),
        "proc.exec" => Some("pal_proc_exec"),
        "proc.spawn" => Some("pal_proc_spawn"),
        "proc.wait" => Some("pal_proc_wait"),
        "proc.kill" => Some("pal_proc_kill"),
        "proc.exit" => Some("pal_proc_exit"),
        "proc.exists" => Some("pal_proc_exists"),
        "proc.on" => Some("pal_proc_on"),
        // Environment
        "env.get" => Some("pal_env_get"),
        "env.set" => Some("pal_env_set"),
        "env.cwd" => Some("pal_env_cwd"),
        "env.all" => Some("pal_env_all"),
        // Time
        "time.now.ms" => Some("pal_time_unix_ms"),
        "time.now.ns" => Some("pal_time_unix_ns"),
        // Memory
        "mem.used" => Some("pal_mem_used"),
        // CPU
        "cpu.count" => Some("pal_cpu_count"),
        _ => None,
    }
}
