...
impl LlvmIrGen {
    ...
    pub(super) fn compile_program(
        ...
        let mut out = vec![
            ...
            "declare i64 @pal_ws_server_accept(i64)".to_string(),
            "declare i32 @pal_ws_server_send_text(i64, ptr)".to_string(),
            "declare ptr @pal_ws_server_recv(i64, i64)".to_string(),
            "declare i32 @pal_ws_server_close(i64)".to_string(),
            "declare i64 @pal_wss_server_accept(i64)".to_string(),
            "declare i32 @pal_wss_server_send_text(i64, ptr)".to_string(),
            "declare ptr @pal_wss_server_recv(i64, i64)".to_string(),
            "declare i32 @pal_wss_server_close(i64)".to_string(),
            // NET functions
