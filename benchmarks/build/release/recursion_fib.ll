...
if_end_2:
  %t4 = load i64, ptr %t0
  %t5 = sub i64 %t4, 1
  %t6 = call i64 @fn_fib(i64 %t5)
  %t7 = load i64, ptr %t0
  %t8 = sub i64 %t7, 2
  %t9 = call i64 @fn_fib(i64 %t8)
  %t10 = add i64 %t6, %t9
  ret i64 %t10
}
...
entry:
  ...
  %t13 = alloca i64
  %t15 = alloca i64
  %t12 = call i64 @mire_wall_mark_ns()
  store i64 %t12, ptr %t11
  %t14 = call i64 @mire_cpu_mark_ns()
  store i64 %t14, ptr %t13
  %t16 = call i64 @fn_fib(i64 20)
  store i64 %t16, ptr %t15
  %t17 = getelementptr inbounds [8 x i8], ptr @.str0, i64 0, i64 0
  %t18 = load i64, ptr %t15
  %t19 = call ptr @mire_i64_to_string(i64 %t18)
  %t20 = call ptr @concat(ptr %t17, ptr %t19)
  call i32 (ptr, ...) @printf(ptr @.fmt_str, ptr %t20)
  %t21 = getelementptr inbounds [9 x i8], ptr @.str1, i64 0, i64 0
  ...
  %t25 = getelementptr inbounds [8 x i8], ptr @.str2, i64 0, i64 0
  %t26 = load i64, ptr %t13
  %t27 = call ptr @mire_cpu_elapsed_ms_str(i64 %t26)
  %t28 = call ptr @concat(ptr %t25, ptr %t27)
  call i32 (ptr, ...) @printf(ptr @.fmt_str, ptr %t28)
  %t29 = getelementptr inbounds [13 x i8], ptr @.str3, i64 0, i64 0
  %t30 = call i64 @mire_mem_process_bytes()
  %t31 = call ptr @mire_mem_format(i64 %t30)
