...
entry:
  ...
  %t8 = call ptr @mire_dict_set_i64(ptr %t6, i64 3, i64 1, i64 0, ptr %t7, i64 100)
  store ptr %t8, ptr %t4
  %t9 = load ptr, ptr %t4
  %t10 = getelementptr inbounds [5 x i8], ptr @.str1, i64 0, i64 0
  %t11 = call ptr @mire_dict_set_i64(ptr %t9, i64 3, i64 1, i64 0, ptr %t10, i64 200)
  store ptr %t11, ptr %t4
  %t13 = load ptr, ptr %t4
  %t14 = call ptr @mire_dict_keys(ptr %t13)
  store ptr %t14, ptr %t12
  %t16 = load ptr, ptr %t4
  %t17 = call ptr @mire_dict_values(ptr %t16)
  store ptr %t17, ptr %t15
  %t18 = getelementptr inbounds [6 x i8], ptr @.str2, i64 0, i64 0
  %t19 = load ptr, ptr %t12
  %t20 = call ptr @mire_dict_to_string(ptr %t19)
  %t21 = call ptr @concat(ptr %t18, ptr %t20)
  call i32 (ptr, ...) @printf(ptr @.fmt_str, ptr %t21)
  %t22 = getelementptr inbounds [8 x i8], ptr @.str3, i64 0, i64 0
  %t23 = load ptr, ptr %t15
  %t24 = call ptr @mire_dict_to_string(ptr %t23)
  %t25 = call ptr @concat(ptr %t22, ptr %t24)
  call i32 (ptr, ...) @printf(ptr @.fmt_str, ptr %t25)
  %t26 = getelementptr inbounds [9 x i8], ptr @.str4, i64 0, i64 0
  %t27 = load i64, ptr %t0
  %t28 = call ptr @mire_wall_elapsed_ms_str(i64 %t27)
  %t29 = call ptr @concat(ptr %t26, ptr %t28)
  call i32 (ptr, ...) @printf(ptr @.fmt_str, ptr %t29)
  ret i32 0
}
