; ModuleID = 'build/release/simple_fn_call.ll'
source_filename = "build/release/simple_fn_call.ll"
...
entry:
  %t8 = tail call ptr @mire_i64_to_string(i64 30)
...
entry:
  %t8.i = tail call ptr @mire_i64_to_string(i64 30)
  %len_b.i.i = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %t8.i)
  %alloc_len.i.i = add i64 %len_b.i.i, 8
  %new.i.i = tail call i64 @malloc(i64 %alloc_len.i.i)
  %new_ptr.i.i = inttoptr i64 %new.i.i to ptr
  tail call void @memcpy(ptr %new_ptr.i.i, ptr nonnull @.str0, i64 7)
  %dest.i.i = getelementptr i8, ptr %new_ptr.i.i, i64 7
  tail call void @memcpy(ptr %dest.i.i, ptr nonnull %t8.i, i64 %len_b.i.i)
  %0 = getelementptr i8, ptr %new_ptr.i.i, i64 %len_b.i.i
  %end.i.i = getelementptr i8, ptr %0, i64 7
