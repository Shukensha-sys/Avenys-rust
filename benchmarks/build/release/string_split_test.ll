...
entry:
  %t0 = alloca ptr
  %t3 = alloca ptr
  %t1 = getelementptr inbounds [17 x i8], ptr @.str0, i64 0, i64 0
  %t2 = call ptr @mire_string_copy(ptr %t1)
  store ptr %t2, ptr %t0
  %t4 = load ptr, ptr %t0
  %t5 = getelementptr inbounds [2 x i8], ptr @.str1, i64 0, i64 0
  %t6 = call ptr @mire_strings_split(ptr %t4, ptr %t5)
  store ptr %t6, ptr %t3
  %t7 = getelementptr inbounds [7 x i8], ptr @.str2, i64 0, i64 0
  %t8 = load ptr, ptr %t3
  %t9 = call ptr @mire_string_concat(ptr %t7, ptr %t8)
  call i32 (ptr, ...) @printf(ptr @.fmt_str, ptr %t9)
  %t10 = getelementptr inbounds [10 x i8], ptr @.str3, i64 0, i64 0
  %t11 = load ptr, ptr %t0
  %t12 = call ptr @mire_string_concat(ptr %t10, ptr %t11)
  call i32 (ptr, ...) @printf(ptr @.fmt_str, ptr %t12)
  ret i32 0
}
