...
entry:
  %t0 = getelementptr inbounds [25 x i8], ptr @.str0, i64 0, i64 0
  call i32 (ptr, ...) @printf(ptr @.fmt_str, ptr %t0)
  %t1 = call i64 @malloc(i64 256)
  %t2 = inttoptr i64 %t1 to ptr
  %t3 = call i32 (ptr, ...) @scanf(ptr @.scanf_str, ptr %t2)
  %t4 = inttoptr i64 %t1 to ptr
  call i32 (ptr, ...) @printf(ptr @.fmt_str, ptr %t4)
  %t5 = getelementptr inbounds [5 x i8], ptr @.str1, i64 0, i64 0
  call i32 (ptr, ...) @printf(ptr @.fmt_str, ptr %t5)
  ret i64 0
}
