...
define i64 @fn_pair(i64 %arg_x, i64 %arg_y) {
entry:
  %t0 = alloca i64
  %t1 = alloca i64
...
entry:
  %t5 = alloca i64
  %t6 = call i64 @fn_pair(i64 3, i64 4)
  store i64 %t6, ptr %t5
  %t7 = getelementptr inbounds [3 x i8], ptr @.str0, i64 0, i64 0
  %t8 = load i64, ptr %t5
  %t9 = call ptr @mire_i64_to_string(i64 %t8)
  %t10 = call ptr @mire_string_concat(ptr %t7, ptr %t9)
  call i32 (ptr, ...) @printf(ptr @.fmt_str, ptr %t10)
  ret i64 0
}
