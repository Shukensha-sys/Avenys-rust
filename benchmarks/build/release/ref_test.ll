...
entry:
  ...
  store i64 10, ptr %t4
  store i64 20, ptr %t5
  %t6 = getelementptr inbounds [3 x i8], ptr @.str0, i64 0, i64 0
  %t7 = load i64, ptr %t4
  %t8 = call ptr @mire_i64_to_string(i64 %t7)
  %t9 = call ptr @concat(ptr %t6, ptr %t8)
  call i32 (ptr, ...) @printf(ptr @.fmt_str, ptr %t9)
  %t10 = getelementptr inbounds [3 x i8], ptr @.str1, i64 0, i64 0
  %t11 = load i64, ptr %t5
  %t12 = call ptr @mire_i64_to_string(i64 %t11)
  %t13 = call ptr @concat(ptr %t10, ptr %t12)
  call i32 (ptr, ...) @printf(ptr @.fmt_str, ptr %t13)
  %t14 = getelementptr inbounds [10 x i8], ptr @.str2, i64 0, i64 0
  %t15 = load i64, ptr %t4
  %t16 = load i64, ptr %t5
  %t17 = add i64 %t15, %t16
  %t18 = call ptr @mire_i64_to_string(i64 %t17)
  %t19 = call ptr @concat(ptr %t14, ptr %t18)
  call i32 (ptr, ...) @printf(ptr @.fmt_str, ptr %t19)
  %t20 = getelementptr inbounds [9 x i8], ptr @.str3, i64 0, i64 0
  %t21 = load i64, ptr %t0
  %t22 = call ptr @mire_wall_elapsed_ms_str(i64 %t21)
  %t23 = call ptr @concat(ptr %t20, ptr %t22)
  call i32 (ptr, ...) @printf(ptr @.fmt_str, ptr %t23)
  %t24 = getelementptr inbounds [13 x i8], ptr @.str4, i64 0, i64 0
  %t25 = call i64 @mire_mem_process_bytes()
  %t26 = call ptr @mire_mem_format(i64 %t25)
  %t27 = call ptr @concat(ptr %t24, ptr %t26)
  call i32 (ptr, ...) @printf(ptr @.fmt_str, ptr %t27)
  ret i32 0
}
