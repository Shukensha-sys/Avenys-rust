...
entry:
  ...
  store ptr %t1, ptr %t0
  %t2 = getelementptr inbounds [5 x i8], ptr @.str0, i64 0, i64 0
  %t3 = load ptr, ptr %t0
  %t4 = load ptr, ptr %t0
  %t5 = icmp eq ptr %t4, null
  br i1 %t5, label %list_len_null_0, label %list_len_load_1
list_len_null_0:
  store i64 0, ptr %t8
...
list_len_end_2:
  %t7 = load i64, ptr %t8
  %t9 = call ptr @mire_i64_to_string(i64 %t7)
  %t10 = call ptr @concat(ptr %t2, ptr %t9)
