...
entry:
  %t0 = alloca ptr
  %t3 = alloca ptr
  %t1 = getelementptr inbounds [16 x i8], ptr @.str0, i64 0, i64 0
  %t2 = call ptr @mire_string_copy(ptr %t1)
  store ptr %t2, ptr %t0
  %t4 = load ptr, ptr %t0
  %t5 = call ptr @mire_strings_trim(ptr %t4)
  store ptr %t5, ptr %t3
  %t6 = getelementptr inbounds [9 x i8], ptr @.str1, i64 0, i64 0
  %t7 = load ptr, ptr %t3
  %t8 = call ptr @mire_string_concat(ptr %t6, ptr %t7)
  call i32 (ptr, ...) @printf(ptr @.fmt_str, ptr %t8)
  ret i32 0
}
