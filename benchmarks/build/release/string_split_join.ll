...
entry:
  ...
  store i64 %t3, ptr %t2
  %t5 = getelementptr inbounds [18 x i8], ptr @.str0, i64 0, i64 0
  %t6 = call ptr @mire_string_copy(ptr %t5)
  store ptr %t6, ptr %t4
  %t7 = load ptr, ptr %t4
  %t8 = getelementptr inbounds [6 x i8], ptr @.str1, i64 0, i64 0
  %t9 = getelementptr inbounds [5 x i8], ptr @.str2, i64 0, i64 0
  %t10 = call ptr @mire_strings_replace(ptr %t7, ptr %t8, ptr %t9)
  %t11 = load ptr, ptr %t4
  call void @mire_string_free(ptr %t11)
  store ptr %t10, ptr %t4
  %t13 = load ptr, ptr %t4
  %t14 = getelementptr inbounds [2 x i8], ptr @.str3, i64 0, i64 0
  %t15 = call ptr @mire_strings_split(ptr %t13, ptr %t14)
  store ptr %t15, ptr %t12
  %t16 = getelementptr inbounds [10 x i8], ptr @.str4, i64 0, i64 0
  %t17 = load ptr, ptr %t4
  %t18 = call ptr @mire_string_concat(ptr %t16, ptr %t17)
  call i32 (ptr, ...) @printf(ptr @.fmt_str, ptr %t18)
  %t19 = getelementptr inbounds [7 x i8], ptr @.str5, i64 0, i64 0
  %t20 = load ptr, ptr %t12
  %t21 = call ptr @mire_string_concat(ptr %t19, ptr %t20)
  call i32 (ptr, ...) @printf(ptr @.fmt_str, ptr %t21)
  %t22 = getelementptr inbounds [9 x i8], ptr @.str6, i64 0, i64 0
  %t23 = load i64, ptr %t0
  %t24 = call ptr @mire_wall_elapsed_ms_str(i64 %t23)
  %t25 = call ptr @mire_string_concat(ptr %t22, ptr %t24)
