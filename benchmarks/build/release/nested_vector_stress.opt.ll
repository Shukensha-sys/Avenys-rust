; ModuleID = 'build/release/nested_vector_stress.ll'
source_filename = "build/release/nested_vector_stress.ll"
...
list_len_end_5:
  ...
  %t193 = tail call ptr @mire_i64_to_string(i64 3)
  %len_b.i = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %t193)
  ...
  tail call void @memcpy(ptr %dest.i, ptr nonnull %t193, i64 %len_b.i)
  ...
  %t197 = tail call ptr @mire_i64_to_string(i64 4)
  %len_b.i22 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %t197)
  ...
  tail call void @memcpy(ptr %dest.i27, ptr nonnull %t197, i64 %len_b.i22)
  ...
  %t201 = tail call ptr @mire_i64_to_string(i64 78)
  %len_b.i30 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %t201)
  ...
  tail call void @memcpy(ptr %dest.i35, ptr nonnull %t201, i64 %len_b.i30)
  ...
  %t205 = tail call ptr @mire_i64_to_string(i64 12)
  %len_b.i38 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %t205)
  ...
  tail call void @memcpy(ptr %dest.i43, ptr nonnull %t205, i64 %len_b.i38)
  ...
  %t209 = tail call ptr @mire_wall_elapsed_ms_str(i64 %t1)
  %len_b.i46 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %t209)
  ...
  tail call void @memcpy(ptr %dest.i51, ptr nonnull %t209, i64 %len_b.i46)
  ...
  %t213 = tail call ptr @mire_cpu_elapsed_ms_str(i64 %t3)
  %len_b.i54 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %t213)
  ...
  tail call void @memcpy(ptr %dest.i59, ptr nonnull %t213, i64 %len_b.i54)
  ...
  %t217 = tail call i64 @mire_cpu_cycles_est(i64 %t3)
  %t218 = tail call ptr @mire_i64_to_string(i64 %t217)
  %len_b.i62 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %t218)
  ...
  tail call void @memcpy(ptr %dest.i67, ptr nonnull %t218, i64 %len_b.i62)
  ...
  %t221 = tail call i64 @mire_mem_process_bytes()
  %t222 = tail call ptr @mire_mem_format(i64 %t221)
  %len_b.i70 = tail call i64 @strlen(ptr noundef nonnull dereferenceable(1) %t222)
  ...
  tail call void @memcpy(ptr %dest.i75, ptr nonnull %t222, i64 %len_b.i70)
